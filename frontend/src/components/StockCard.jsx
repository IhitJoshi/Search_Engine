    ...
    <div className="group cursor-pointer h-full">
      <div
        className={`relative h-full rounded-xl p-5 border transition-all duration-300 transform group-hover:-translate-y-1 group-hover:shadow-xl backdrop-blur-sm ${
          stock.changed === "up"
            ? "bg-gray-800/80 border-emerald-500/40 group-hover:border-emerald-400 ring-1 ring-emerald-400/30 shadow-[0_0_22px_rgba(16,185,129,0.35)]"
            : stock.changed === "down"
            ? "bg-gray-800/80 border-red-500/40 group-hover:border-red-400 ring-1 ring-red-400/30 shadow-[0_0_22px_rgba(239,68,68,0.35)]"
